...
import { Briefcase, Users, TrendingUp, Shield, MapPin, Zap, ArrowRight, Star, Check, HelpCircle } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-10 px-4 md:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <RouterLink
              to="/workers"
              className="px-8 py-4 border-2 border-green-600 text-green-600 font-semibold rounded-full hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 flex items-center justify-center"
            >
              Browse Workers
            </RouterLink>
            <button
              onClick={() => setOnboardingOpen(true)}
              className="px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-slate-955 font-black rounded-full hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
            >
