            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`relative flex items-center justify-center p-4 rounded-xl border-2 transition-all duration-200 overflow-hidden ${formData.role === 'worker'
                ...
                <button
                  ...
                  className={`relative flex items-center justify-center p-4 rounded-xl border-2 transition-all duration-200 overflow-hidden ${formData.role === 'company'
                    ? 'border-emerald-500 bg-emerald-500/5 text-emerald-600 dark:text-emerald-400'
                    : 'border-border bg-white dark:bg-card text-muted-foreground hover:border-border/80'
                    }`}
                >
            ...
            <button
              ...
              onClick={() => {
                ...
                window.location.href =
                  `${backendBaseUrl}/oauth2/authorization/facebook`;
