...
export default function CompanyDashboard() {
  ...
  const statCards = [
    { label: 'Open Jobs', value: stats.openJobs, icon: Briefcase, color: 'from-blue-500 to-blue-600', bgColor: 'bg-blue-50 dark:bg-blue-900/20' },
    { label: 'Applications', value: stats.totalApplications, icon: Users, color: 'from-indigo-500 to-indigo-600', bgColor: 'bg-indigo-50 dark:bg-indigo-900/20' },
    { label: 'Hired', value: stats.accepted, icon: CheckCircle, color: 'from-green-500 to-green-600', bgColor: 'bg-green-50 dark:bg-green-900/20' },
    { label: 'Positions Filled', value: stats.filled, icon: TrendingUp, color: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-50 dark:bg-orange-900/20' },
  ];
