...
export default function WelcomePage() {
  ...
  const testimonials = [
    ...
    {
      name: 'Kamla Devi',
      role: language === 'en' ? 'Fruit Picker, Maharashtra' : 'फल बीनने वाली, महाराष्ट्र',
      text: language === 'en'
        ? "I found consistent orchard jobs nearby with honest daily wage rates. I don't pay any broker commissions anymore!"
        : "मुझे ईमानदारी से दैनिक मजदूरी दरों के साथ पास में ही लगातार फलों के बागान का काम मिला। अब मैं किसी भी दलाल को कमीशन नहीं देती!",
      rating: 5
    },
    {
      name: 'Baldev Kumar',
      ...
      text: language === 'en'
        ...
        : "काम लॉगिंग सिस्टम सरल और पारदर्शी है। किसानों ने मुझे वही भुगतान किया जो हमारे काम लॉग पर तय हुआ था।",
      rating: 5
    }
  ];
        ...
        <div className="max-w-3xl mx-auto px-4 text-center space-y-4">
          ...
          <div className="pt-10 text-left space-y-3.5">
            ...
            <div className="bg-white dark:bg-card border border-border rounded-2xl overflow-hidden transition shadow-sm">
              ...
              >
                <span>{t('q1')}</span>
                {activeFaq === 1 ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
              </button>
              {activeFaq === 1 && (
            ...
            <div className="bg-white dark:bg-card border border-border rounded-2xl overflow-hidden transition shadow-sm">
              ...
              >
                <span>{t('q2')}</span>
                {activeFaq === 2 ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
              </button>
              {activeFaq === 2 && (
                <div className="px-6 pb-5 text-xs.5 text-muted-foreground leading-relaxed border-t border-border pt-3 bg-[#f8faf9] dark:bg-muted/10">
                  {t('a2')}
            ...
            <div className="bg-white dark:bg-card border border-border rounded-2xl overflow-hidden transition shadow-sm">
              ...
              >
                <span>{t('q3')}</span>
                {activeFaq === 3 ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
              </button>
              {activeFaq === 3 && (
                <div className="px-6 pb-5 text-xs.5 text-muted-foreground leading-relaxed border-t border-border pt-3 bg-[#f8faf9] dark:bg-muted/10">
                  {t('a3')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10 text-left">
            <div className="bg-background rounded-2xl border border-border overflow-hidden shadow-sm flex flex-col justify-between hover:shadow-md transition">
              ...
              <div className="p-5.5 border-t border-border">
                <a href="#" className="text-xs font-bold text-[#1b4332] dark:text-primary hover:underline">{t('readMore')} →</a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 bg-background p-8 rounded-3xl border border-border shadow-sm text-left">
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                ...
                >
                  {contactSending ? 'Sending...' : t('btnSend')}
                </button>
              </form>
            </div>
