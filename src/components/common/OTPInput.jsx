    ...
    <div className="flex justify-center gap-3 dir-ltr" onPaste={handlePaste}>
      {otp.map((digit, idx) => (
        <input
          ...
          className="w-12 h-12 text-center text-xl font-bold border border-border rounded-lg bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all disabled:opacity-50 disabled:bg-muted"
        />
      ))}
    </div>
  );
